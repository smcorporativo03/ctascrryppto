...
class CreateTbSalidaalmacenObjsTable extends Migration
{
  /**
   * Run the migrations.
   *
  ...
  public function up()
  {
    Schema::create('tb_salidaalmacen_objs', function (Blueprint $table) {
      $table->increments('id')->unsigned();
      $table->datetime('fecha');
      $table->integer('idProveedor')->nullable()->unsigned();
      $table->integer('idTipoDocumento')->unsigned();
      $table->string('nroDocumento',15);
      $table->integer('idTipoDocumentoRef')->nullable()->unsigned();
      $table->string('nroDocumentoRef',15)->nullable();
  ...
  {
    Schema::dropIfExists('tb_salidaalmacen_objs');
  }
}
